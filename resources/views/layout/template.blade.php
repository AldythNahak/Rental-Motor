  ...
  <div id="home" class="banner">
    <div class="banner-agileinfo">
      ...
      <div class="header">
        <div class="container">   
          <div class="logo">
            <h1><span class="fa fa-motorcycle hi-icon"><span></span><a href="{{URL('/')}}">Rental MOTOR Salatiga</a></h1>
          </div> 
          <div class="menu">
            ...
            <nav>  
              ...
              <a href="#booking" class="scroll"><span class="fa fa-motorcycle hi-icon">     Booking</span></a> 
              <a href="#spec" class="scroll"><span class="glyphicon glyphicon-list-alt"> Specifications</span></a> 
              <a href="#about" class="scroll"><span class="glyphicon glyphicon-question-sign"> About</span></a>
              <a href="#contact" class="scroll"><span class="glyphicon glyphicon-phone-alt"> Contact Us</span></a> 
            </nav>
            <script>
            (function($){
              // Menu Functions
      ...
      <div class="banner-text">
        <div class="container">   
          <h2>We Provide the best <span>MOTORBIKES</span>To Rent</h2>
          <a href="#booking" class="buy btn-wayra scroll"> Book Now</a>
        </div> 
      </div>
    </div>
  </div>
